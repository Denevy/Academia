...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2015 a las 05:31:17
...
--
-- Estructura de tabla para la tabla `periodoprogra`
--

CREATE TABLE IF NOT EXISTS `periodoprogra` (
  `idperiodoprogra` int(11) NOT NULL AUTO_INCREMENT,
  `nombreperiodoprogra` int(11) DEFAULT NULL,
  PRIMARY KEY (`idperiodoprogra`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13 ;

--
-- Volcado de datos para la tabla `periodoprogra`
--

INSERT INTO `periodoprogra` (`idperiodoprogra`, `nombreperiodoprogra`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
