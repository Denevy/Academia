<?php 
	...
	unset($info['r2']);
	$query="INSERT INTO `docente`(`carnet`,`nombre`,`profesion`,`telefono`,`correo`,`fk_idEstados`, `fk_idrestriccionprogramacion`)
						VALUES ('$carnet','$nombre','$profesion','$telefono','$correo', '$estado','$nacceso')";
