...
<!--modal alerta eliminar usuario -->
                     ...
                     <!-- modal -->
                      ...
                      <div class="row">
                        <div class="col-md-1 ">
                          <button type="button" id="btnmodaladdDpensum" class="btn btn-primary btn-lg center" data-toggle="modal" data-target="#Modal_DPensum">
                            ...
                            <div class="modal-body">
                              ...
                              <form action="" class="form-horizontal" id="form_Dpensum" >
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon" id="sizing-addon2" class="glyphicon glyphicon-user" aria-hidden="true"></span>
                                  <input type="text" class="form-control" placeholder="Ingrese el id del curso" aria-describedby="sizing-addon2" id="Dpensum_idcurso">
                                </div>
                                <br>
                                <div class="input-group">
                                  <span class="input-group-addon" id="sizing-addon2" class="glyphicon glyphicon-lock" aria-hidden="true"></span>
                                  <input type="text" class="form-control" placeholder="Ingrese el id del ciclo" aria-describedby="sizing-addon2" id="Dpensum_idciclo">
                                </div>
                                 <br>
                                <div class="input-group">
                                  <span class="input-group-addon" id="sizing-addon2" class="glyphicon glyphicon-user" aria-hidden="true"></span>
                                  <input type="text" class="form-control" placeholder="Ingrese el id del pensum " aria-describedby="sizing-addon2" id="pensum_idpensum">
                                </div>
